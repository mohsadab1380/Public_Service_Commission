...
public class MalpracticeCase {
    ...
    public MalpracticeCase(String caseId, String candidateRoll, String candidateName, String examCentre, String incidentType, String invigilatorRemarks, String candidateHistory, LocalDate reportDate, List<String> evidenceFiles, String status) {
        this.caseId = caseId;
